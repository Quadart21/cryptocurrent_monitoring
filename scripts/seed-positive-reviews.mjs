...
const TEXTS = [
  "Обмен прошёл быстро, курс устроил, буду обращаться ещё.",
  "Всё отлично: заявка ушла за минуты, поддержка на связи.",
  "Уже не первый раз меняю здесь — всегда без сюрпризов.",
  "Хороший курс и понятный интерфейс. Рекомендую.",
  "Перевод пришёл быстрее, чем ожидал. Спасибо!",
  "Нормальный обменник, без лишних вопросов. Всё чётко.",
  "Курс честный, комиссия понятная, деньги пришли вовремя.",
  "Поддержка ответила быстро и помогла с заявкой. Плюс.",
  "Обменял USDT на карту — всё прошло гладко.",
  "Удобно, быстро, без задержек. Буду рекомендовать друзьям.",
  "Заявка обработана оперативно, курс совпал с заявленным.",
  "Работают стабильно, уже несколько обменов — всё ок.",
  "Понравилось, что статус заявки видно сразу. Спасибо.",
  "Хороший сервис, особенно для срочного обмена.",
  "Всё прозрачно: сумма, курс, сроки. Без сюрпризов.",
  "Обмен сделали быстро, поддержка вежливая.",
  "Курс выгодный, перевод пришёл вовремя. Отлично.",
  "Уже второй раз здесь — оба раза без проблем.",
  "Интерфейс простой, обмен занял пару минут.",
  "Надёжный обменник, деньги пришли как обещали.",
  "Быстро ответили в чате и провели обмен. Рекомендую.",
  "Курс лучше, чем у многих, и без задержек.",
  "Всё прошло с первого раза, заявку подтвердили сразу.",
  "Удобно менять крипту, всё работает стабильно.",
  "Отличный опыт: быстро, понятно, без лишней суеты.",
  "Поддержка помогла с реквизитами, обмен прошёл сразу.",
  "Курс устроил, сумма пришла полностью. Спасибо.",
  "Обмен без задержек, буду пользоваться дальше.",
  "Хороший обменник для регулярных операций.",
  "Всё чётко и по делу. Заявку закрыли быстро.",
  "Понравилась скорость и адекватный курс.",
  "Менял крупную сумму — всё прошло спокойно.",
  "Уже несколько раз менял, всегда без нареканий.",
  "Сервис удобный, уведомления приходят вовремя.",
  "Быстрый обмен и нормальная поддержка. Плюс.",
  "Курс совпал с калькулятором, перевод пришёл сразу.",
  "Всё работает как надо. Рекомендую знакомым.",
  "Обмен занял меньше 10 минут. Отлично.",
  "Прозрачные условия, без скрытых комиссий.",
  "Хороший опыт: быстро ответили и провели обмен.",
  "Удобный личный кабинет и понятные статусы.",
  "Заявку обработали оперативно, курс выгодный.",
  "Всё прошло гладко, спасибо команде.",
  "Меняю уже не первый месяц — стабильно и быстро.",
  "Поддержка на связи, обмен без задержек.",
  "Курс хороший, перевод пришёл вовремя. Буду ещё.",
  "Отличный сервис для обмена крипты.",
  "Всё просто и быстро. Рекомендую.",
  "Заявка ушла сразу, деньги пришли как обещали.",
  "Нормальный курс и быстрая обработка. Спасибо!",
];
